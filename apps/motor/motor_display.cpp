...
SmallMotorDisplay::SmallMotorDisplay(pvtui::PVGroup& pvgroup, const std::string& record)
    : record_name(record),
    desc(pvgroup, record + ".DESC"),
    val(pvgroup, record + ".VAL"),
    twr(pvgroup, record + ".TWR", " < "),
    twv(pvgroup, record + ".TWV"),
...
LargeMotorDisplay::LargeMotorDisplay(pvtui::PVGroup& pvgroup, const std::string& record)
    ...
    dval(pvgroup, record + ".DVAL"),
    hlm(pvgroup, record + ".HLM"),
    dhlm(pvgroup, record + ".DHLM"),
    llm(pvgroup, record + ".LLM"),
    dllm(pvgroup, record + ".DLLM"),
    spmg(pvgroup, record + ".SPMG", pvtui::ChoiceStyle::Vertical),
    vmax(pvgroup, record + ".VMAX"),
    velo(pvgroup, record + ".VELO"),
    vbas(pvgroup, record + ".VBAS"),
    accl(pvgroup, record + ".ACCL"),
    mres(pvgroup, record + ".MRES"),
    eres(pvgroup, record + ".ERES"),
    rres(pvgroup, record + ".RRES"),
    rtry(pvgroup, record + ".RTRY"),
    off(pvgroup, record + ".OFF"),
    prec(pvgroup, record + ".PREC"),
    rlv(pvgroup, record + ".RLV"),
    rval(pvgroup, record + ".RVAL"),
